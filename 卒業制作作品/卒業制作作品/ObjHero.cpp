			...
			if (Input::GetVKey('Q') == true)
			{
				if (m_Grenade_flg == true && m_gre_pb_me > 0)
				{
					...
					if (m_UDani_frame == 0)
					{
						...
						Objs::InsertObj(obj_gre, OBJ_GRENADEATTACK, 4);
					}
					//右
				...
				if (m_Weapon_switching == 0 && m_hg_pb > 0)
				{
					...
					if (m_bt == 1)
					{
						...
						if (m_UDani_frame == 0)
						{
							...
							Objs::InsertObj(obj_ga, OBJ_GUNATTACK, 4);
						}
						//右
						else if (m_UDani_frame == 2)
						{
				...
				else if (m_Weapon_switching == 1 && m_sg_pb > 0)
				{
					...
					if (m_bt == 1)
					{
						...
						if (m_UDani_frame == 0)
						{
							...
							Objs::InsertObj(obj_sga, OBJ_SHOTGUNATTACK, 4);
				...
				else if (m_Weapon_switching == 2 && m_ar_pb > 0)
				{
					...
					if (m_bt == 1)
					{
						...
						if (m_UDani_frame == 0)
						{
							...
							Objs::InsertObj(obj_ara, OBJ_ARATTACK, 4);
						}
						//右
						else if (m_UDani_frame == 2)
						{
				...
				else if (m_Weapon_switching == 3 && m_sr_pb > 0)
				{
					...
					if (m_bt == 1)
					{
						...
						if (m_UDani_frame == 0)
						{
							...
							Objs::InsertObj(obj_sra, OBJ_SNIPERRIFLEATTACK, 4);
						}
						//右
						else if (m_UDani_frame == 2)
						{
				...
				else if (m_Weapon_switching == 4 && m_rl_pb > 0)
				{
					...
					if (m_bt == 1)
					{
						...
						if (m_UDani_frame == 0)
						{
							...
							Objs::InsertObj(obj_rla, OBJ_ROCKETLAUNCHERATTACK, 4);
						}
						//右
						else if (m_UDani_frame == 2)
						{
				...
				else if (m_Weapon_switching == 5 && m_rg_pb > 0)
				{
					...
					if (m_bt == 1)
					{
						...
						if (m_UDani_frame == 0)
						{
							...
							Objs::InsertObj(obj_rga, OBJ_RAILGUNATTACK, 4);
						}
						//右
						else if (m_UDani_frame == 2)
						{
