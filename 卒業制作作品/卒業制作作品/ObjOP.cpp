...
void CObjOP::Draw()
{
	...
	Font::StrDraw(L"　財団の機動部隊である主人公は、SCP-354を収容するために", GAME_OP_X, GAME_OP_Y + m_y + 500, GAME_OP_FONT_SIZE, p);
	Font::StrDraw(L"エリア３５４に送られました。", GAME_OP_X, GAME_OP_Y + m_y + 550, GAME_OP_FONT_SIZE, p);
