...
void CObjOP::Draw()
{
	...
	Font::StrDraw(L"勤務していました。", GAME_OP_X, GAME_OP_Y + m_y + 600, GAME_OP_FONT_SIZE, p);
	Font::StrDraw(L"　だがある時、そのオブジェクトの収容違反が発生し", GAME_OP_X, GAME_OP_Y + m_y + 700, GAME_OP_FONT_SIZE, p);
	Font::StrDraw(L"施設が壊滅しました。主人公はある機会を起動させ、", GAME_OP_X, GAME_OP_Y + m_y + 750, GAME_OP_FONT_SIZE, p);
